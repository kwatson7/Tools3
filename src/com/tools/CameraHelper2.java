...
implements SurfaceHolder.Callback{
	 ...
	 */
	public CameraHelper2(int jpegQuality, ExceptionCaught exceptionCaught){
	 ...
	 * @throws CameraHelperException if we could not find a preview size to fit in window
	 */
	public void onResume(OnRotationCallback rotationCallback, WidthHeight windowToFitSurface) throws CameraHelperException {
	 ...
	 */
	public void openFrontCamera()throws CameraHelperException{
		...
		// no camera
		if (camera == null)
			throw new CameraHelperException("no accessible front facing camera");
	}
